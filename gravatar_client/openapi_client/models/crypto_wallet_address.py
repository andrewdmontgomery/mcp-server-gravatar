...
class CryptoWalletAddress(BaseModel):
    ...
    """ # noqa: E501
    label: StrictStr = Field(description="The label for the crypto currency.")
    address: StrictStr = Field(description="The wallet address for the crypto currency.")
    __properties: ClassVar[List[str]] = ["label", "address"]
