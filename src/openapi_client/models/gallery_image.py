...
class GalleryImage(BaseModel):
    ...
    """ # noqa: E501
    url: StrictStr = Field(description="The URL to the image.")
    alt_text: Optional[StrictStr] = Field(default=None, description="The image alt text.")
    __properties: ClassVar[List[str]] = ["url", "alt_text"]
