...
class AssociatedResponse(BaseModel):
    ...
    AssociatedResponse
    """ # noqa: E501
    associated: StrictBool = Field(description="Whether the entity is associated with the account.")
    __properties: ClassVar[List[str]] = ["associated"]
